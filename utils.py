...
def load_data(fname, seed=1234, verbose=True):
    ...
    if verbose:
        ...
        print("u_features: {}, v_features: {}".format(u_features.shape, v_features.shape))
...
def create_trainvaltest_split(dataset, seed=1234, testing=False, datasplit_path=None, datasplit_from_file=False,
    ...
    load_data function.
    For each split computes 1-of-num_classes labels. Also computes training adjacency matrix.
    """
